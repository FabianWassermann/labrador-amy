<template>
  <div class="relative overflow-hidden bg-white py-16">
    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-prose prose prose-lg text-lg">
        <figure>
          <img
            class="w-full rounded-lg"
            src="@/assets/welpe.jpeg"
            alt=""
            width="1310"
            height="873"
          />
      ...
      <div class="prose prose-lg prose-sky mx-auto mt-6 text-gray-500">
        ...
        <p>Ihr Vorbild ...</p>
        <ul role="list">
          <li>in der Aufzucht der Welpen</li>
          <li>bei der gewissenhaften Auswahl der Welpenvergabe</li>
          <li>
            bei der Unterstützung der zukünftigen Hundeführer bei jeglichen
            Fragen
          </li>
          <li>ihrer lieben und ehrlichen Art</li>
        </ul>
        <p>... wissen wir sehr zu schätzen.</p>
        <h2>Amy's Eltern</h2>
        ...
        <figure>
          <img
            class="w-full rounded-lg"
            src="@/assets/documents/ahnentafel.webp"
            alt=""
            width="1310"
            height="873"
          />
          <figcaption>Ahnentafel</figcaption>
        </figure>
      </div>
    </div>
  </div>
